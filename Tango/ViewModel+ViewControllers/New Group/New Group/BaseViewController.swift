...
class BaseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tabBarView.onClickSearchtButtonAction = {() -> Void in
            let mainView = UIStoryboard(name:"Dashboard", bundle: nil)
            let viewcontroller : UIViewController = mainView.instantiateViewController(withIdentifier: "SearchVC") as! SearchVC
            self.navigationController?.pushViewController (viewcontroller, animated: false)
        }
