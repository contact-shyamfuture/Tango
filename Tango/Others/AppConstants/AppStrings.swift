...
let enterValidFirstName = "Please enter first name."
...
let shouldEnterTheGender = "Please select gender."
let shouldEnterTheEmailName = "Please enter user phone."
...
let shouldEnterTheConfirmPassword = "Please enter user  Confirm password."
let shouldEnterRightPassword = "Please enter the same password as you put in the password field."
let shouldSelectAnySpeciality = "Please Select any Speciality."
let shouldSelectCountry = "Please Select country."
let shouldSelectPhone = "Please enter phone number."
...
let testName = "Please enter name of test result"
...
//AddMedication
let enterMedicationInfo = "Please Write Some Medication Info."

//AddVitral
let enterDateInfo = "Please select a date first"
let enterWeightInfo = "Please Enter Patient Weight"
let enterHeightInfo = "Please Enter Patient Height"
let enterBPSysInfo = "Please Enter Patient BP(Sys)"
let enterBPDiasInfo = "Please Enter Patient BP(Dias)"
let enterBMIInfo = "Please Enter Patient BMI"

//BookAppointMent
let enterTxtSpecialityInfo = "Please Select Text Speciality"
let enterTxtDateInfo = "Please Select a date"
let enterTxtDateTime = "Please Select reminder time"
let enterTxtPatientInfo = "Please Enter a patient name"
let enterTxtPhoneNoInfo = "Please Enter a phone number"
