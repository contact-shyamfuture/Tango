...
extension UIViewController {
    func topHeaderSet(vc : UIViewController){
        let topHeaderVC = TopHeaderVC(nibName: "TopHeaderVC", bundle: nil)
        topHeaderVC.view.frame = CGRect(x: 0, y: 0, width: vc.view.bounds.width, height: 90)
        vc.view.addSubview(topHeaderVC.view)
        self.addChild(topHeaderVC)
    }
